...
class RoomObjects
{
    ///<summary>Iterate through the different type of objects (Interactive, breakable or collectable) and execute that specific function</summary>
    public static void IterateAction(List<Base> roomObjects, Type type)
    {
        foreach (Base roomObject in roomObjects)
        {
            ...
            else if (type == typeof(IBreakable) && roomObject is IBreakable)
                ((IBreakable)roomObject).Break();
            else if (type == typeof(ICollectable) && roomObject is ICollectable)
